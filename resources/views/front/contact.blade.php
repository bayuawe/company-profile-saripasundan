...
@section('title', 'Sari Pasundan Pekanbaru - Kontak')
@section('content')
        ...
        <div class="max-w-7xl px-4 lg:px-8 py-12 lg:py-24 mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
                <div class="aspect-w-16 aspect-h-6 lg:aspect-h-14 overflow-hidden bg-gray-100 rounded-2xl">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.6720984010585!2d101.43390624110964!3d0.49053349823137515!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d5af68678fac15%3A0xd3de773762360dd9!2sSari%20Pasundan%20Pekanbaru!5e0!3m2!1sen!2sid!4v1715832425842!5m2!1sen!2sid"
                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="grow">
                                    <p class="text-sm text-gray-600">
                                        Pekanbaru, Riau, Indonesia, 28124
                                    </p>
                                    <address class="mt-1 text-black not-italic">
                                        Jl. Paus, Tengkerang Tengah, <br>Kec. Marpoyan Damai
                                    </address>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                            <div class="flex gap-4">
                                ...
                                <div class="grow">
                                    ...
                                    <p>
                                        <a class="relative inline-block font-medium text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-yellow-400 hover:before:bg-black focus:outline-none focus:before:bg-black"
                                            href="mailto:saripasundan.pku@gmail.com">
                                            saripasundan.pku@gmail.com
                                        </a>
                                    </p>
                                </div>
                            </div>
