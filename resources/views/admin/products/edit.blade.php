                        ...
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                            ...
                            <form method="POST" action="{{ route('admin.products.update', $product) }}"
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input value="{{ $product->name }}" id="name" class="block mt-1 w-full"
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input value="{{ $product->price }}" id="price" class="block mt-1 w-full"
                                ...
                                <div class="mt-4">
                                    ...
                                    <textarea name="about" id="about" class="w-full py-3 pl-5 border border-gray-300 rounded-lg">{{ $product->about }}</textarea>
                                    <x-input-error :messages="$errors->get('category')" class="mt-2" />
                                </div>
