...
<div class="bg-yellow-400">
    ...
    <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
        ...
        <div class="max-w-3xl mb-10 lg:mb-14">
            <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Tertarik Join Reseller?</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
            ...
            <div>
                ...
                <a class="group inline-flex items-center gap-x-2 py-2 px-3 bg-white font-medium text-sm text-yellow-400 rounded-full focus:outline-none"
                    href="#">
