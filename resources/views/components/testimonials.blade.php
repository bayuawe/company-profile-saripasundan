<section>
    <!-- Testimonials -->
    <div class="overflow-hidden bg-yellow-400">
        <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl text-white font-semibold">
                    Terselip Manisnya Cita Rasa:<br>Testimoni Pelanggan dari Toko Kue Balok Sari Pasundan
                </h2>
            </div>
            <!-- End Title -->
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-col bg-white rounded-xl">
                        <div class="flex-auto p-4 md:p-6">
                            <p class="text-base italic md:text-lg text-gray-800">
                                " <span class="font-bold">Coklat Lumer yang gak bikin enek sama sekali</span>, dan
                                MasyaAllah banyak yang
                                suka.
                                Tempatnya bersih dan banyak menu yang lainnya. Jangan lupa mampir ya ke Sari Pasundan
                                Pekanbaru. 🤗 "
                            </p>
                        </div>

                        <div class="p-4 bg-yellow-100 rounded-b-xl md:px-7">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img class="size-8 sm:h-[2.875rem] sm:w-[2.875rem] rounded-full"
                                        src="https://lh3.googleusercontent.com/a-/ALV-UjXVCcSMykw8IpwHCS860u7dEkikWlfcG310vpVWZG0OB9xEIY0r=w32-h32-p-rp-mo-br100"
                                ...
                                <div class="grow ms-3">
                                    ...
                                    <div class="flex items-center mt-1">
                                        <svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"
                                            ...
                                            <path
                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.683-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.565-1.838-.197-1.54-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                            </path>
                                        </svg>
                                        <svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="text-xs text-gray-500 ml-2">Review Google Maps</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex h-auto">
                    <div class="flex flex-col bg-white rounded-xl">
                        <div class="flex-auto p-4 md:p-6">
                            <p class="text-base italic md:text-lg text-gray-800">
                                " Toko kue ini menawarkan kue coklat unik yang belum ada di toko lain, dengan <span
                                    class="font-bold">harga
                                    bersaing</span> dan beragam pilihan menu lainnya. "
                            </p>
                        </div>
                        ...
                        <div class="p-4 bg-yellow-100 rounded-b-xl md:px-7">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img class="size-8 sm:h-[2.875rem] sm:w-[2.875rem] rounded-full"
                                        src="https://lh3.googleusercontent.com/a-/ALV-UjVMgOF7A8mZgPmKgSByUhYZv8IF7N-7GK3LNPAdTZ155G21c_Pk=w32-h32-p-rp-mo-ba5-br100"
                                        alt="Image Description">
                                </div>
                ...
                <div class="flex h-auto">
                    <div class="flex flex-col bg-white rounded-xl">
                        <div class="flex-auto p-4 md:p-6">
                            <p class="text-base italic md:text-lg text-gray-800">
                                " <span class="font-bold">Enak Rotinya Bener-bener Lumeerr...</span> Sering2 kasih
                                Harga promo/discont donk biar sering beli...😁😁😁 "
                            </p>
                        </div>
                        ...
                        <div class="p-4 bg-yellow-100 rounded-b-xl md:px-7">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img class="size-8 sm:h-[2.875rem] sm:w-[2.875rem] rounded-full"
                                        src="https://lh3.googleusercontent.com/a-/ALV-UjXJu5gPGcDO8F9gANgXxEj-LSFaH-P-no-Ovxdb0Sb3e-JXeYU=w32-h32-p-rp-mo-ba4-br100"
                                        alt="Image Description">
                                </div>
            ...
            <div class="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
                <!-- Stats -->
                <div>
                    <h4 class="text-lg sm:text-xl font-semibold text-white">Reseller Resmi</h4>
                    <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-gray-800">10,000+</p>
                    <p class="mt-1 text-white">Di berbagai daerah di Indonesia</p>
                </div>
                <!-- End Stats -->

                <!-- Stats -->
                <div>
                    <h4 class="text-lg sm:text-xl font-semibold text-white">Outlet</h4>
                    <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-gray-800">6+</p>
                    <p class="mt-1 text-white">Outlet resmi</p>
                </div>
                <!-- End Stats -->
            ...
            <div class="absolute bottom-0 end-0 transform lg:translate-x-32" aria-hidden="true">
                <svg class="w-40 h-auto sm:w-72" width="1115" height="636" viewBox="0 0 1115 636"
                    ...
                    <path
                        ...
                        fill="currentColor" class="fill-orange-200" />
                    <path
