    ...
    <div class="text-center">
        ...
        <div class="mt-3">
            <p class="text-yellow-500"> Kami adalah bagian dari<a
                    class="font-semibold text-yellow-400 hover:text-yellow-500" href="#"> CV. Sari Pasundan
                    Berkah</a>.</p>
            <p class="text-yellow-500">© 2024 CV. Sari Pasundan Berkah. All rights reserved.</p>
        </div>
